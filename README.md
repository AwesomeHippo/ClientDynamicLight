# Client Dynamic Light (Forge - 1.20.1)
...
This branch is for **Forge 1.20.1**.

Check other branches for other Minecraft versions.

## Contributors

- Huge thanks to **e3ndr** for GTNH's Backhand support, armor support and code refactoring on the 1.7.10 branch.
- Special thanks to **MayIHaveK** for zh_CN translation.
- Special thanks to **Thenemex** for profiling/testing on the 1.7.10 branch.
